...
/**
 * Proxy API route to forward house plan requests to Admin API
...
export async function GET(
  ...
  const url = `${adminApiUrl}/api/houses/${houseId}/plan`

  console.log('🔄 Proxying house plan request to Admin API:', url)
  ...
  try {
    ...
    console.log('✅ Admin API returned house plan:', data.plan?.filename || 'no filename')
